...
sns.heatmap(raw_data, annot=True, fmt='.3g', linewidths=.5, ax=ax, xticklabels=['Hits@1','Hits@3','Hits@5','Hits@10','MRR'], yticklabels=lbls).figure.savefig(path + "raw_heatmap.png")
f, ax = plt.subplots(figsize=(9, 6))
sns.heatmap(zeroed_data, annot=True, fmt='.3g', linewidths=.5, ax=ax, xticklabels=['Hits@1','Hits@3','Hits@5','Hits@10','MRR'], yticklabels=lbls).figure.savefig(path + "zeroed_heatmap.png")
