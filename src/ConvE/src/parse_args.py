...
parser.add_argument('--experiment_name', type=str, default="experiment",
                    help='name of experiment output folder')
parser.add_argument('--sl_checkpoints', type=int, default=8,
                    help='number of SSRL cycles to compute')
parser.add_argument('--total_iterations', type=int, default="1000",
                    help='Number of RL training steps per cycle')
parser.add_argument('--total_iterations_sl', type=int, default="1000",
                    help='Number of SL training steps per cycle')
parser.add_argument('--eval_every', type=int, default="100",
                    help='Number of RL training steps between in-progress evaluations')
...
parser.add_argument('--num_epochs_sl', type=int, default=200,
                    help='maximum number of pass over the entire training set during SL training (default: 20)')
...
parser.add_argument('--learning_rate_sl', type=float, default=0.001,
                    help='learning rate (default: 0.0001)')
